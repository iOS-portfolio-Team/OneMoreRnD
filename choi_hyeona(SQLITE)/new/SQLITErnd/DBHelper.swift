...
class DBHelper
{
    ...
    func updateByID(exerciseSequenceNumer : Int, exerciseComment : String) {
        let updateStatementStirng = "UPDATE WorkoutLog set exerciseComment = ? WHERE exerciseSequenceNumer = ?;"
        ...
        if sqlite3_prepare_v2(db, updateStatementStirng, -1, &updateStatement, nil) == SQLITE_OK {
            ...
            sqlite3_bind_int(updateStatement, 2, Int32(exerciseSequenceNumer))
